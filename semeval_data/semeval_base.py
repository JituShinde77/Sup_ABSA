...
def main(argv=None):
    ...
    try:
        ...
        print ('PASSED! This corpus has: %d sentences, %d aspect term occurrences, and %d distinct aspect terms.' % (len(elements), len(aspects), len(list(set(aspects)))))
    except:
    ...
    if task == 4:
        ...
        print ('Accuracy = %f, #Correct/#All: %d/%d' % Evaluate(seen.corpus, predicted).aspect_category_polarity_estimation())
    ...
    if task == 5:
        ...
        print ('Task 1: P = %f -- R = %f -- F1 = %f (#correct: %d, #retrieved: %d, #relevant: %d)' % Evaluate(seen.corpus, predicted).aspect_extraction())
       # print ('Task 2: P = %f -- R = %f -- F1 = %f (#correct: %d, #retrieved: %d, #relevant: %d)' % Evaluate( seen.corpus, predicted).category_detection())
    ...
    if task == 6:
        ...
        print ('Task 3: Accuracy = %f (#Correct/#All: %d/%d)' % Evaluate(seen.corpus, predicted).aspect_polarity_estimation())
        print ('Task 4: Accuracy = %f (#Correct/#All: %d/%d)' % Evaluate(seen.corpus, predicted).aspect_category_polarity_estimation())
